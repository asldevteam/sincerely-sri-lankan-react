...
export const destinations: Destination[] = [
  {
    ...
    position: { x: 50.5, y: 36 },
    mobilePosition: { x: 42, y: 36.5 },
    type: "cultural",
    description:
  ...
  },
  {
    id: "mirissa",
    name: "Mirissa Beach",
    position: { x: 53, y: 83.5 },
    mobilePosition: { x: 51, y: 81 },
    type: "beach",
    description:
